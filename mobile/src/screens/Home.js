...
import { getSuggestions, getGoals, getWatch, getFreshPrices } from "../api/client";
...
export default function Home({ navigation }) {
  ...
  const load = useCallback(async () => {
    ...
    setAlert(watch.alerts?.find((a) => a.severity === "danger") || watch.alerts?.[0] || null);
  ...
  return (
    ...
    >
      <Text style={st.hi}>Morning, Chioma 👋</Text>
